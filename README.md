...
📁 [`/zech-pneumonia-generalization`](/zech-pneumonia-generalization.docx)
...
See also: [`Argus`](https://github.com/batouldjaafar39-create/Argus.git) — original research on evidence-grounded LLM-assisted SOC investigation.
